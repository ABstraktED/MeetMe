...
<link rel="stylesheet"
	href="${resource(dir: 'css', file: 'meetme-auth.css')}" type="text/css">
...
<body>
	...
	<div class="container">
		...
		<div id="logo"></div>
		<div id="title">too fast, too easy</div>
		<div id="subtitle">Meet anyone, anywhere, without any effort.</div>
		...
		<div id="form-cont">
			...
			<form action='${postUrl}' method='POST' name="loginForm"
				...
				<div>
					...
					<input type="text" name="j_username" class="form-control clearfix"
						placeholder="username" required="" autofocus=""> <input
						type="password" name="j_password" class="form-control clearfix"
					...
					<div id="login-help">
						...
						</label> | <span class="forgot-link"> <g:link controller='register'
