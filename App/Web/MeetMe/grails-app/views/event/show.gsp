...
<script type="text/javascript"
	...
	<div style="display: inline-block;">
		<div style="float: left; padding-right: 100px">
			...
			${eventInstance.title }
			<br />
			<g:message code="lbl.event.date" />
			<g:formatDate format="dd/MM/yyyy" date="${eventInstance.date }" />
			<br />
			<g:message code="lbl.event.time" />
			<g:formatDate format="hh:mm" date="${eventInstance.date }" />
			<br />
			<g:message code="lbl.event.description" />
			${eventInstance.description }
			<br />
			<g:message code="lbl.event.location" />
			${eventInstance.location.address }
			<br />
			<g:message code="lbl.event.creator" />
		...
		<div style="float: right">
			...
			<div id="invite">
				<h3>
					<g:message code="lbl.event.invite" />
				</h3>
			...
			<div id="googleContact">
				<a
					...
					<g:message code="value.event.inviteGoogleContact" />
				</a>
			</div>
			<div id="invited">
				<h3>
					<g:message code="lbl.event.invited" />
				</h3>
				<g:each in="${invited }" var="inv">
					<g:message code="lbl.event.userName" />
					${inv.user.username }
					<br />
					<g:message code="lbl.event.email" />
					${inv.user.email }
				</g:each>
			</div>
		</div>
	...
	<div>
		<h3>
			<g:message code="lbl.event.discussion" />
		</h3>
		<br />
		...
		<g:form action="newComment">
			<g:set var="pholder"
				value="${message(code: 'placeholder.event.insertComment')}" />
