...
<g:applyLayout name="event_layout">
	...
	<content tag="event_content">
						...
						<td><g:set var="emailValue"
							...
							<g:if test="${emailValue != '---'}">
								<a
									...
									onclick="return confirm('Are you sure you want do invite this contact?')"><g:message code='msg.meetme.inviteByEmail'/></a>
							</g:if></td>
						<td><g:set var="phoneValue"
							...
							<g:if test="${phoneValue != '---'}">
								<a
									...
									onclick="return confirm('Are you sure you want do invite this contact?')"><g:message code='msg.meetme.inviteByPhone'/></a>
							</g:if></td>
					</tr>
				</g:each>
		...
		<a href="<g:createLink action="inviteFromGoogleContactsDone" controller="invitation"/>"><g:message code='msg.meetme.done'/></a>
		</div>
</content>
</g:applyLayout>
