...
<html>
	<head>
		<head>
			...
			<link rel="stylesheet" href="${resource(dir: 'css', file: 'meetme-event-layout.css')}" type="text/css">
	...
	<body>
		...
		<div id="content-left">
			<a href="<g:createLink controller="invitation" action="list"/>" >My Events</a> <br /> 
			<a href="<g:createLink controller="event" action="newEvent"/>">Create Event</a> <br /> 
			<a href="<g:createLink controller="event" action="list"/>">Find Events</a> <br /> 
