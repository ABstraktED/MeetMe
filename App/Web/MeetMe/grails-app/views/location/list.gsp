...
<body>
	<a href="#list-location" class="skip" tabindex="-1"><g:message
			...
			<thead>
				<tr>
					...
					<g:sortableColumn property="address"
						title="${message(code: 'location.address.label', default: 'Address')}" />

					<g:sortableColumn property="latitude"
						title="${message(code: 'location.latitude.label', default: 'Latitude')}" />

					<g:sortableColumn property="longitude"
						title="${message(code: 'location.longitude.label', default: 'Longitude')}" />
				...
				<g:each in="${locationInstanceList}" status="i"
					...
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${locationInstance.id}">
								${fieldValue(bean: locationInstance, field: "address")}
							</g:link></td>

						<td>
							${fieldValue(bean: locationInstance, field: "latitude")}
						</td>

						<td>
							${fieldValue(bean: locationInstance, field: "longitude")}
						</td>
